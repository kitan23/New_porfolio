  ...
  return (
    <Layout title="netflix-clone">
      <Container>
        ...
        <P>
          A Netflix Clone created with ReactJS, which also happens to be my
          first React project
        </P>
        <List ml={4} my={4}>
          <ListItem>
            ...
            <Link href="https://kitan23.github.io/movies-info/" target="_blank">
              https://kitan23.github.io/movies-info/{' '}
        ...
        <WorkImage
          src="/images/works/netflix-clone-1.png"
          alt="Netflix clone"
        />
        <WorkImage
          src="/images/works/netflix-clone-2.png"
          alt="Netflix clone"
        />
      </Container>
    </Layout>
